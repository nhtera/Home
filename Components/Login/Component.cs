namespace Rennder.Components
{
    public class Login : Component
    {
        ...
        public override string Render()
        {
            ...
            string htm = "<iframe id=\"loginframe" + itemId + "\" style=\"width:100%; height:100%; background-color:transparent;\"  frameborder=\"0\" scrolling=\"no\" src=\"" + loginHost + "/rennder/Login/LoadForm?w=" + R.Page.websiteId + "&u=" + R.Page.ownerId + "&l=" + R.Page.layoutId + "&lu=" + R.Page.layoutOwner + "&s=" + DataField.Replace("|", ",") + "&d=" + DesignField.Replace("|", ",") + loginQuery;
